...
export default function Service() {
  return (
   ...
   <div className="w-[420px] hover:bg-gray-700 shadow-shadow hover:shadow-slate-500 duration-500 group hover:text-gray-300 bg-[#f0ebd8] rounded-xl text-black p-8">
