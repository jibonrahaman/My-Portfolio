...
export default function Service() {
  return (
   ...
   <div className="w-[420px] hover:bg-gray-700 shadow-shadow hover:shadow-slate-500 duration-500 group hover:text-gray-300 bg-[#dae1e1f2] rounded-xl text-black p-6">
   ...
   <p className=" font-dm">I am excited to share my expertise in translating Figma designs into meticulously crafted HTML code. With a strong command of HTML5, CSS3, and JavaScript, I ensure seamless and pixel-perfect conversions. I look forward to the opportunity to contribute to your team's success.
    ...
    <div className="w-[420px] bg-[#dae1e1f2] hover:bg-gray-700 shadow-shadow hover:shadow-slate-500 duration-500  group hover:text-gray-300  rounded-xl text-black p-6">
